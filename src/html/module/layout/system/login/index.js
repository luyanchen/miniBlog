...
NEJ.define([
     ...
     */
    _p._$$ModuleLayoutSystemLogin = _k._$klass();
    _pro = _p._$$ModuleLayoutSystemLogin._$extend(_m._$$Module);
    /**
     * 解析模块所在容器节点
     * @param  {Object} 配置信息
    ...
    _pro.__doBuild = function(){
        ...
        this.__export = {
            parent:_list[0]//子模块容器
        };
    };
    // notify dispatcher
    _t1._$regist('layout-system-login',_p._$$ModuleLayoutSystemLogin);
});
